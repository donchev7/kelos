...
VERSION ?= latest
IMAGE_DIRS ?= cmd/kelos-controller cmd/kelos-spawner cmd/ghproxy cmd/kelos-webhook-server cmd/cody-tools claude-code codex gemini opencode cursor cmd/kelos-slack-server cmd/kelos-usage-collector
